...
session_start();
if(isset($_SESSION['fchat']))
{
    $senderName=$_SESSION['fchat']['senderName'];
    $senderEmail=$_SESSION['fchat']['senderEmail'];
    $senderDp=$_SESSION['fchat']['senderDp'];
    $recieverName=$_SESSION['fchat']['recieverName'];
    $recieverEmail=$_SESSION['fchat']['recieverEmail'];
    $recieverDp=$_SESSION['fchat']['recieverDp'];
    $cname=$_SESSION['fchat']['cname'];
    $chatId=$_SESSION['fchat']['chatId'];
}
else
{
        ...
        <div class="py-5">
            <div class="contacts12-main" style="background-color: aqua;border-radius: 20px;height:666px; width: 90%; padding: 3px;">
                <div class="header-section text-center">
                    <p style="float:left;margin:7px;margin-top:18px;"><a href="logout.php" onclick="location.href=this.href+'?user='+'fchat';return false;"><span class="fa fa-arrow-left"></a></span></p>
                ...
                <div style="margin-top:4px;">
                    <form action="fchatroom.php" method="post" autocomplete="off">
